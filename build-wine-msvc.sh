...
WINEPATH=${_winepath_} wine qmake.exe ./../helloworld.pro -spec win32-msvc CONFIG+=x86_64 CONFIG+=release "QMAKE_CXXFLAGS*=-IC:/buildenv/deps/msvc14/include" "QMAKE_CXXFLAGS*=-IC:/buildenv/deps/windows-kits/10/Include/10.0.10240.0/ucrt" "QMAKE_LFLAGS*=C:/buildenv/msvc14/lib/msvcprt.lib" "QMAKE_LFLAGS*=C:/buildenv/msvc14/lib/MSVCRT.lib" "QMAKE_LFLAGS*=C:/buildenv/msvc14/lib/OLDNAMES.lib" "QMAKE_LFLAGS*=C:/buildenv/windows-kits/8.1/Lib/winv6.3/um/x86/kernel32.lib" "QMAKE_LFLAGS*=C:/buildenv/msvc14/lib/vcruntime.lib" "QMAKE_LFLAGS*=C:/buildenv/windows-kits/10/Lib/10.0.10240.0/ucrt/x86/ucrt.lib"
